...
public class Filtre4Controller implements Initializable  {
	...
	public void RemplirList(){
		...
		String sql = "SELECT  matricule ,nom_Sal ,email_Sal ,categorie ,salaire ,recrutement from  salarier   having salaire=MIN(salaire)";
