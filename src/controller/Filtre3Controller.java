...
public class Filtre3Controller implements Initializable {
	...
	public void RemplirList(){
		...
		String sql = "SELECT s.categorie,s.matricule, s.nom_Sal,s.email_Sal,s.salaire,s.recrutement,v.id_m,v.idCatge,v.commision,v.pct,v.vente  from  vendeur v , salarier s    where ((s.matricule=v.id_m) and (s.categorie=v.idCatge))  having (v.commision=MAX(v.commision)) ";
